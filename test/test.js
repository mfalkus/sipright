...
const canonical_message = 'INVITE sip:5000@sip.host.com;user=phone SIP/2.0\r\n\
Via: SIP/2.0/TCP 192.168.178.22:38488;branch=z9hG4bK1428069545;rport;alias\r\n\
From: "Lorenzo250" <sip:250@sip.host.com;user=phone>;tag=1459587455\r\n\
To: <sip:5000@sip.host.com;user=phone>\r\n\
Call-ID: 2015279366-5066-167@BJC.BGI.BHI.CC\r\n\
...
describe("SIPRight", function() {
 describe("SIP Parser", function() {
    ...
    it("Validation warnings defaults to empty array", function() {
      const canonicalParsed = sipright.getSIP(canonical_message);
      expect(canonicalParsed.validation_warnings).to.be.an('array');
      expect(canonicalParsed.validation_warnings.length).to.equal(0);
    });
